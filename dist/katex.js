...
/*#__PURE__*/
function () {
  function SymbolNode(text, height, depth, italic, skew, width, classes, style, loc) {
    this.text = void 0;
    this.height = void 0;
    this.depth = void 0;
    this.italic = void 0;
    ...
    this.style = style || {};
    this.maxFontSize = 0;
    this.loc = loc || null; // Mark text from non-Latin scripts with specific classes so that we
  ...
  _proto4.toNode = function toNode() {
    ...
    if (span) {
      ...
      if (this.loc != null) {
        var _this$loc = this.loc,
            start = _this$loc.start,
            end = _this$loc.end;
...
var buildCommon_makeSymbol = function makeSymbol(value, fontName, mode, options, classes) {
  ...
  if (metrics) {
    ...
    symbolNode = new domTree_SymbolNode(value, metrics.height, metrics.depth, italic, metrics.skew, metrics.width, classes, undefined, loc);
  } else {
    // TODO(emily): Figure out a good way to only print this in development
    typeof console !== "undefined" && console.warn("No character metrics for '" + value + "' in style '" + fontName + "'");
    symbolNode = new domTree_SymbolNode(value, 0, 0, 0, 0, 0, classes, undefined, loc);
  }
