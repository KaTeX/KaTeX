...
class SymbolNode {
  constructor(text, height, depth, italic, skew, width, classes, style, loc) {
    this.text = void 0;
    this.height = void 0;
    this.depth = void 0;
    this.italic = void 0;
...
const makeSymbol = function makeSymbol(value, fontName, mode, options, classes) {
  ...
  if (metrics) {
    ...
    symbolNode = new SymbolNode(value, metrics.height, metrics.depth, italic, metrics.skew, metrics.width, classes, undefined, loc);
  } else {
    // TODO(emily): Figure out a good way to only print this in development
    typeof console !== "undefined" && console.warn("No character metrics for '" + value + "' in style '" + fontName + "'");
    symbolNode = new SymbolNode(value, 0, 0, 0, 0, 0, classes, undefined, loc);
  }
