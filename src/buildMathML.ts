 ...
 */
export const makeText = function(text: string, mode: Mode, options?: Options): TextNode {
 ...
 */
export const getVariant = function(group: SymbolParseNode, options: Options): FontVariant | null {
 ...
 * <mtext> tag.
 */
export const buildExpression = function(expression: AnyParseNode[], options: Options, isOrdgroup?: boolean): MathNode[] {
 ...
 */
export const buildExpressionRow = function(expression: AnyParseNode[], options: Options, isOrdgroup?: boolean): MathDomNode {
 ...
 */
export const buildGroup = function(group: AnyParseNode | null, options: Options): MathNode {
    if (!group) {
