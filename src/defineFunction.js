...
export type FunctionPropSpec<ATYPES: ArgType[], OTYPES: ArgType[]> = {
...
type FunctionDefSpec<NODETYPE: NodeType, ATYPES: ArgType[], OTYPES: ArgType[]> = {|
    ...
    props: FunctionPropSpec<ATYPES, OTYPES>,
...
export default function defineFunction
    ...
    htmlBuilder,
    mathmlBuilder,
}: FunctionDefSpec<NODETYPE, ATYPES, OTYPES>) {
