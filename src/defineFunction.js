...
export type FunctionHandler<NODETYPE: NodeType, ARGTYPES: ArgType[]> = (
...
export type FunctionPropSpec<ARGTYPES: ArgType[]> = {
...
type FunctionDefSpec<NODETYPE: NodeType, ARGTYPES: ArgType[]> = {|
    ...
    props: FunctionPropSpec<ARGTYPES>,

    // The handler is called to handle these functions and their arguments and
    // returns a `ParseNode`.
    handler: ?FunctionHandler<NODETYPE, ARGTYPES>,
 ...
 */
export type FunctionSpec<NODETYPE: NodeType, ARGTYPES: ArgType[]> = {|
    type: NODETYPE,
    argTypes?: ARGTYPES,
    optionalArgTypes?: ArgType[],
    greediness: number,
...
export default function defineFunction<NODETYPE: NodeType, ARGTYPES: ArgType[]>({
    type,
    names,
    props,
    handler,
    htmlBuilder,
    mathmlBuilder,
}: FunctionDefSpec<NODETYPE, ARGTYPES>) {
