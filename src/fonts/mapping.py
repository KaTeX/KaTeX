# The mapping defined by this file is a dict from the original TeX font files
# to the translated modern font names. The modern font names are dictionaries
# that map every character in the TeX font to Unicode scalar values.
#
# The key of the mappings of these characters are either simple character codes
# represented by integer values, or tuples of two integers that describe a
# range (inclusive) of characters that should be mapped starting at the Unicode
# mapped Unicode scalar value. So the mapping
#
#   (0x41, 0x43): 0x41
#
# Maps 0x41, 0x42, and 0x43 to the same Unicode scalar values (0x41, 0x42, and
# 0x43) again.
#
# Because Python dictionaries have unique keys, if a character is mapped to
# multiple Unicode scalar values you must use a list of values to emulate a
# multimap.
#
# The Unicode scalar values are either represented as an integer, or as a
# tuple containing additional shifts to apply when copying the glyphs into the
# new font. These shifts will be applied by FontForge. The two additional
# values for the shift are the x and y shift respectively.
...
mapping['cmmi10'] = {
    'Math-Italic': {
        ...
        0x6F: 0x3BF,          # omicron
        # \imath (These differ from \i and \j, so use PUA character)
        0x7B: 0xE131,
        0x7C: 0xE237,         # \jmath
    },
...
mapping['cmsy10'] = {
    'Main-Regular': {
        ...
        # \surd    ### adjust position so font doesn't have a large depth
        0x70: (0x221A, 0, 760),
        0x71: 0x2A3F,          # \amalg
        0x72: 0x2207,          # \nabla
        0x73: 0x222B,          # \int
...
mapping['cmex10'] = {
    'Size1': {
        ...
        0x62: [
            0x2C6,             # \widehat
            (0x302, -556, 0),  # \widehat (combining)
        ],
        0x65: [
            0x2DC,             # \widetilde
            (0x303, -556, 0),  # \widetilde (combining)
        ],
    ...
    'Size2': {
        ...
        0x63: [
            0x2C6,              # \widehat
            (0x302, -1000, 0),  # \widehat (combining)
        ],
        0x66: [
            0x2DC,              # \widetilde
            (0x303, -1000, 0),  # \widetilde (combining)
        ],
        0x68: (0x5B, 0, 1110),    # [
        0x69: (0x5D, 0, 1110),    # ]
    ...
    'Size3': {
        ...
        0x64: [
            0x2C6,              # \widehat
            (0x302, -1444, 0),  # \widehat (combining)
        ],
        0x67: [
            0x2DC,              # \widetilde
            (0x303, -1444, 0),  # \widetilde (combining)
        ],
    ...
    'Size4': {
        ...
        # \braceld, \bracerd, \bracelu, \braceru (PUA)
        (0x7A, 0x7D): 0xE150,
    },

    'Main-Regular': {
        # left curly brace upper hook, for lgroup, lmoustache
        0x38: (0x23B0, 0, 900),
        # right curly brace upper hook, for rgroup, rmoustache
        0x39: (0x23B1, 0, 900),
...
mapping['msbm10'] = {
    'Size4': {
        0x5B: [
            0x2C6,              # \widehat
            (0x302, -1889, 0),  # \widehat (combining)
        ],
        0x5D: [
            0x2DC,              # \widetilde
            (0x303, -1889, 0),  # \widetilde (combining)
        ],
    },
    ...
    'AMS': {
        ...
        0x5C: [
            0x2C6,              # \widehat
            (0x302, -2333, 0),  # \widehat (combining)
        ],
        0x5E: [
            0x2DC,              # \widetilde
            (0x303, -2333, 0),  # \widetilde (combining)
        ],
        ...
        0x7A: [
            0x03DD,         # \digamma
            0xE008,         # \digamma  (non-standard, for IE)
        ],
        0x7B: [
            0x03F0,         # \varkappa
            0xE009,         # \varkappa (non-standard, for IE)
        ],
        0x7C: 0x006B,         # \Bbbk
        0x7D: 0x210F,         # \hslash
        0x7E: 0x0127,         # \hbar
