...
export type StrictFunction = ((errorCode: string, errorMsg: string, token?: Token | AnyParseNode) => boolean | string | null);
...
export type TrustFunction = ((context: AnyTrustContext) => boolean | null);
