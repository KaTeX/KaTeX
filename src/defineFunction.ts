...
import { ParseNode, AnyParseNode, NodeType, UnsupportedCmdParseNode } from "./parseNode";
import Options from "./Options";
import { ArgType, BreakToken } from "./types";
...
export type HtmlBuilder<NODETYPE> = ((parseNode: ParseNode<NODETYPE>, options: Options) => HtmlDomNode);
export type MathMLBuilder<NODETYPE> = ((group: ParseNode<NODETYPE>, options: Options) => MathDomNode);

// More general version of `HtmlBuilder` for nodes (e.g. \sum, accent types)
// whose presence impacts super/subscripting. In this case, ParseNode<"supsub">
// delegates its HTML building to the HtmlBuilder corresponding to these nodes.
export type HtmlBuilderSupSub<NODETYPE> = ((arg0: ParseNode<"supsub"> | ParseNode<NODETYPE>, options: Options) => HtmlDomNode);
...
type FunctionDefSpec<NODETYPE extends NodeType> = {
    ...
    // returns a `ParseNode`.
    handler: FunctionHandler<NODETYPE> | null,
...
export type FunctionSpec<NODETYPE extends NodeType> = {
    ...
    handler: FunctionHandler<unknown> | null
};
...
export const _functions: {
    [K in string]: FunctionSpec<unknown>;
} = {};
...
export const _htmlGroupBuilders: {
    [K in string]: HtmlBuilder<unknown>;
} = {};
...
export const _mathmlGroupBuilders: {
    [K in string]: MathMLBuilder<unknown>;
} = {};
