 ...
 */
const getMetrics = function(symbol: string, font: string, mode: Mode): CharacterMetrics {
 ...
 */
const mathrmSize = function(value: string, size: number, mode: Mode, options: Options): SymbolNode {
 ...
 */
const makeInner = function(symbol: string, font: "Size1-Regular" | "Size4-Regular", mode: Mode): VListElem {
    let sizeClass;
 ...
 */
const makeSqrtImage = function(height: number, options: Options): {
    span: SvgSpan,
    ruleWidth: number,
    advanceWidth: number
} {
 ...
 */
const traverseSequence = function(delim: string, height: number, sequence: Delimiter[], options: Options): Delimiter {
