...
const sqrtInnerSVG = {
    // The main path geometry is from glyph U+221A in the font KaTeX Main
...
7-6 0-10-1-12-3L160 575l-65 47zM834 0h399166v40H845z'/></svg>`,
    // size1 is from glyph U+221A in the font KaTeX_Size1-Regular
...
175-136 283s-89.167 185.333-111.5 232-33.833 70.333-34.5 71c-4.667 4.667-12.333
 ...
 -22 17.333-33.333 26-34 26L0 720l76-59 76-60zM890 0h399110v40H901z'/></svg>`,
    // size2 is from glyph U+221A in the font KaTeX_Size2-Regular
...
c-6-5.333-15-14-27-26l25-30c26.667-32.667 52-63 76-91l52-60 208 722c56-175.333
 ...
 872 10c4-6.667 10-10 18-10zm0 0h399110v40H902z'/></svg>`,
    // size3 is from glyph U+221A in the font KaTeX_Size3-Regular
...
M890 0h399110v40H903z'/></svg>`,
    // size4 is from glyph U+221A in the font KaTeX_Size4-Regular
...
104 606zM890 0h399110v40H906z'/></svg>`,
    // tall is from glyph U+23B7 in the font KaTeX_Size4-Regular
...
const sqrtSpan = function(height, delim, options) {
    ...
    if (delim.type === "small") {
        ...
        span.style.height = span.height + "em";
        // Set surd width with data from the fonts.
        span.surdWidth = [0, 0.901, 0.902, 0.903, 0.903][delim.size] /
            sizeMultiplier;
