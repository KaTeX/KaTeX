...
const sqrtTall = function(extraViniculum: number, hLinePad: number, viewBoxHeight: number): string {
...
export const sqrtPath = function(size: string, extraViniculum: number, viewBoxHeight: number): string {
