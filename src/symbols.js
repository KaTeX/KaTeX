...
defineSymbol(math, main, textord, "€", "\\€");
defineSymbol(text, main, textord, "€", "\\€");
defineSymbol(text, main, textord, "€", "\\texteuro");
defineSymbol(math, main, textord, "¥", "\\¥");
defineSymbol(text, main, textord, "¥", "\\¥");
defineSymbol(text, main, textord, "¥", "\\textyen");
defineSymbol(math, main, textord, "₹", "\\₹");
defineSymbol(text, main, textord, "₹", "\\₹");
defineSymbol(text, main, textord, "₹", "\\textrupee");
defineSymbol(math, main, textord, "₽", "\\₽");
defineSymbol(text, main, textord, "₽", "\\₽");
defineSymbol(text, main, textord, "₽", "\\textruble");
defineSymbol(math, main, textord, "%", "\\%");
defineSymbol(text, main, textord, "%", "\\%");
