 ...
 */
const renderToString = function(expression: string, options: SettingsOptions): string {
 ...
 */
const generateParseTree = function(expression: string, options: SettingsOptions): AnyParseNode[] {
