...
KaTeX supports all major browsers, including Chrome, Safari, Firefox, Opera, and IE 9 - IE 11. A list of supported commands can be found on the [wiki](https://github.com/Khan/KaTeX/wiki/Function-Support-in-KaTeX).
