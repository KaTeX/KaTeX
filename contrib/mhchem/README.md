...
```html
<script defer src="https://cdn.jsdelivr.net/npm/katex@0.13.0/dist/contrib/mhchem.min.js" integrity="sha384-i1fMa7yGUmsRwCdcKhDFNW/4t7vm25cdrncNf66/CE7smFYHjdEgLTfQ+GFFLlZO"  crossorigin="anonymous"></script>
```
