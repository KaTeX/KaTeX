...
|\cdotp|$\cdotp$||
|\cdots|$\cdots$||
|\ce{C6H5-CHO} |$\ce{C6H5-CHO}$|See [mhchem Manual](https://mhchem.github.io/MathJax-mhchem/) for much more info.
...
|\psi|$\psi$||
|\Psi|$\Psi$||
|\pu{123 kJ/mol}|$\pu{123 kJ/mol}$|See [mhchem Manual](https://mhchem.github.io/MathJax-mhchem/) for much more info.|
